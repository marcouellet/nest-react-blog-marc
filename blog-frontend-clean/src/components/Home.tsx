...
function Home():JSX.Element {
  ...
  const deletePost = async(id: string) => {
    ...
    await fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/post/delete?postID=${id}`, {
      method: "delete",
      headers: new Headers({
                  ...
                  <li>
                    {
                      ...
                      <Link to={`/post/edit/${post._id}`} className="btn btn-sm btn-outline-secondary">Edit Post </Link>
                    }
                  </li>
                  <li>
                    {
